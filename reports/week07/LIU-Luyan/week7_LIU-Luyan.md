...
2. 发现灯珠来自 **CogVideoX 模型本身在当前环境下的行为** ，不是 VideoPainter 的代码问题。VideoPainter 用的是 diffusers 0.31.0.dev0（预发布版），而官方 diffusers 后来发布了 0.31.0 正式版以及 0.32、0.33 等更新版本。如果是 dev0 的 bug，大概率在后续版本里已经修了。
